...
<html>
	...
	<div id="delusermodal" class="modal fade">
		<div class="modal-dialog"  style="width:200px">
			...
			<form action="<%=request.getContextPath() %>/UserManagerControl" method="POST">
	...
	<!-- Left-Navbar -->
		<div style="background-color:white;width:30%;display:inline-block;">
			<jsp:include page="leftnavbar.jsp">
				<jsp:param value="<%=LeftNavbar.UserManager.User_Manager %>" name="active"/>
			</jsp:include>
		</div>
	<!-- Left-Navbar -->
		...
		<div style="padding-left:20px;background-color:#fff;border:1px solid #e6e6e6;width:69%;display:inline-block;float:right">
				...
				%>
					<tr>
						...
						<td><%=u.getLevel() %></td>
						<td><%=u.getIntegral() %></td>
						<td><button data-toggle="modal" data-target="#delusermodal" data-userid="<%=u.getId() %>" class="btn btn-primary">删除用户</button></td>
					</tr>
				<%
				}
				%>
